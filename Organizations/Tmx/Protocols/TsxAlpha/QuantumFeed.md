## TsxAlpha Quantum Feed: TSX Alpha Exchange Quantum Feed Level 1 And Level 2

Market data feed publishing real-time order book, quote, and trade data for equities traded on the TSX Alpha Exchange.

### Overview

Quantum Feed is the TSX Alpha Exchange market data product, publishing real-time quote and trade events for equities traded on the TSX Alpha Exchange. The feed is available in Level 1 and Level 2 tiers, where Level 1 carries top of book quotations and Level 2 carries aggregated depth of book for subscribers that need visibility beyond the best bid and offer.
...
- **TSX Alpha Exchange** - Coverage of the TSX Alpha Exchange
